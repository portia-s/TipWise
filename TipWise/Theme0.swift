...
enum Theme: Int {
    case GoGreen, PrettyPink, BearyBrown
    ...
    var navigationBackgroundImage: UIImage? {
        return self == .BearyBrown ? UIImage(named: "navBackground") : nil
    }
    
    var tabBarBackgroundImage: UIImage? {
        return self == .BearyBrown ? UIImage(named: "tabBarBackground") : nil
    }
